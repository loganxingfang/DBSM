...
! Open met file and start loop over timesteps
      ...
      do step=1,nsteps
        if (mod(step,48).eq.0) 
     &     print('(I3,"% complete")'),100*step/nsteps
...
! Write final SWE and depth grids
      ...
      do j=1,n
        write(31,*) (S(i,j),i=1,n)
        write(33,*) (S(i,j)/rho(i,j),i=1,n)
      enddo
      close(31)
      close(33)
